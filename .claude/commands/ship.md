...
**Important:** Do NOT update CHANGELOG.md or package.json version on feature branches. This avoids merge conflicts. Changelog and version updates happen on main after the PR merges.
